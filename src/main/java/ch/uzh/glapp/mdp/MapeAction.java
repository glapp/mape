...
//			if (cell.getIntValForAttribute(MapeWorldDomain.NUM_CELLS) <= MapeWorldDomain.LOW_MEDIUM_THRESHOLD) {
//				cell.setValue(MapeWorldDomain.NUM_CELLS_CATEGORY, MapeWorldDomain.LOW);
//			} else if (cell.getIntValForAttribute(MapeWorldDomain.NUM_CELLS) <= MapeWorldDomain.MEDIUM_HIGH_THRESHOLD) {
//				cell.setValue(MapeWorldDomain.NUM_CELLS_CATEGORY, MapeWorldDomain.MEDIUM);
//			} else {
//				cell.setValue(MapeWorldDomain.NUM_CELLS_CATEGORY, MapeWorldDomain.HIGH);
//			}
				}
			}
